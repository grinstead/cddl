...
export type StartRuleNames = "cddl";
export interface ParseOptions<T extends StartRuleNames = "cddl"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"cddl">>(
  input: string,
  options?: Options,
): unknown;
